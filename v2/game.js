class Game{
	...
	init() {
		...
		loader.load( `${this.assetsPath}fbx/girl-walk.fbx`, function ( object ) {
            ...
            game.loadBau(loader, 506, -113);
            game.loadKey(loader, 265, 0, -217);
            game.loadKey(loader, 265, 0, -122);
            game.loadKey(loader, 265, 0, -35);
		} );
	...
	createDummyEnvironment(){
        ...
        const geometry1 = new THREE.BoxBufferGeometry( 50, 50, 85 );
        ...
        //506, -113
        const block = new THREE.Mesh(geometry1, material1);
        block.position.set(505, 50, -113);
        block.castShadow = true;
        env.add(block);
    ...
    createCubeMaterial() {
        var cubeTexture = new THREE.TextureLoader().load("caixa.jpg");
	...
	createCameras(){
		...
		front.position.set(112, 100, 150);
		front.parent = this.player.object;
		const back = new THREE.Object3D();
		back.position.set(20, 110, -290);
		back.parent = this.player.object;
		const wide = new THREE.Object3D();
		wide.position.set(178, 139, 400);
		wide.parent = this.player.object;
		const overhead = new THREE.Object3D();
		overhead.position.set(0, 550, 100);
